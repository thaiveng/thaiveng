...
final List<Recommendation> demoRecommendations = [
  ...
  Recommendation(
      ...
      source: "Upwork",
      text:
          "Noor did really a great job, he is method and has a large knowledge when it comes to Android development (Firebase, Parse Server, User experience), he did more than we expected, highly recommend and we will definitely hire him again."),
  Recommendation(
      name: "AlFaizkhan Pathan",
      source: "Upwork",
      text:
